    ...
    tf_listener(tf_buffer)
{
        ...
        agv1_as2.gantry_preset = { -7.6, -4.50, 1.57, 0.0, -1.13, 1.88, -0.72, 1.55, 0.83 };
        agv1_as2.name = "agv1_as2";
        agv2_as2.gantry_preset = { -7.6, -1.35, 1.57,  0.0, -1.13, 1.88, -0.72, 1.55, 0.83 };
        agv2_as2.name = "agv2_as2";
        agv3_as4.gantry_preset = { -7.6, 1.35, 1.57, 0.0, -1.13, 1.88, -0.72, 1.55, 0.83};
        agv3_as4.name = "agv3_as4";
        agv4_as4.gantry_preset = { -7.6, 4.50, 1.57, 0.0, -1.13, 1.88, -0.72, 1.55, 0.83 };
